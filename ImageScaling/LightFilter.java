...
import java.io.*;
import java.util.*;
import jhlabs.math.ImageFunction2D;
import jhlabs.math.Function2D;
...
*/
				...
				bump = (Function2D) new ImageFunction2D(softPixels, bumpWidth, bumpHeight, ImageFunction2D.CLAMP, bumpSource == BUMPS_FROM_IMAGE_ALPHA);
...
//				v = v > 0.5f ? 0.5f : v;
			...
			return v;
				...
				bump =  (Function2D) new ImageFunction2D(inPixels, width, height, ImageFunction2D.CLAMP, bumpSource == BUMPS_FROM_IMAGE_ALPHA);
		}
